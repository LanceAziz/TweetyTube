...
public final class CastDto {
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.example.tweetytube.features.details.data.remote.response.CastDto copy(boolean adult, int cast_id, @org.jetbrains.annotations.NotNull()
